...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: PvecFb5b5bZM/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: hc3fA-aXz2bY/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: cMl5BLNOgSQK/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__qghS)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg__rObLr)}
                role={"img"}
              />
            ),
